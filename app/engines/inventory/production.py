...
class InventoryProductionService:
    ...
    def reserve(self, tenant_id: int, item_id: str, warehouse_id: str, quantity: Decimal, reference: str) -> InventoryReservation:
        q = _positive(quantity); self._tenant_item(tenant_id,item_id); self._tenant_warehouse(tenant_id,warehouse_id)
        ...
        r=InventoryReservation(tenant_id=tenant_id,item_id=item_id,warehouse_id=warehouse_id,quantity=q,reference=reference,status='active')
