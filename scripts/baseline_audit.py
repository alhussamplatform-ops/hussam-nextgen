...
def check_obvious_secrets() -> None:
    ...
    allowed = {".env.example", "docs/V1_30_REPOSITORY_PRODUCTION_BASELINE.md"}
    for p in ROOT.rglob("*"):
...
def check_migration_chain() -> None:
    ...
    if heads != ["0015_marketplace_trust_ai_integration"]:
...
def main() -> int:
    ...
    print("Hussam NextGen v1.30 baseline audit")
